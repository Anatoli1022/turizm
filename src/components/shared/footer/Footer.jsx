    ...
    <footer className={cx('footer')}>
      <div className={cx('container', 'footer-container')}>
        <div className={cx('contacts')}>
          ...
          <a href="tel:+48577141227" className={cx('link')}>+48 577 141 227</a>
        ...
        <div className={cx('social')}>
          ...
          <div className={cx('icons')}>
            <a href="https://www.facebook.com/people/Zapoluj-Na-Wakacje/pfbid05VYFWrf76kDrYQhT25MgF9HkS7goiqZMKvWQmWZ1mMY9tAvQMhwEoiXehuUzxd9bl/">
              <img src={facebook} loading="lazy" alt="facebook" />
            </a>
            <a href="https://www.messenger.com/t/100010889255784">
              <img src={messenger} loading="lazy" alt="facebook-messenger" />
            </a>
            <a href="https://www.tiktok.com/@zapolujna.wakacje?_t=8dqsGATSgRu&_r=1">
              <img src={tiktok} loading="lazy" alt="tiktok" />
            </a>

            <a href="https://wa.me/+48577141227">
